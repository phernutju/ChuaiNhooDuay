...
import 'screen/volunteer_feed.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Volunteers land on the live "Nearby Requests" feed; requesters keep the
    // placeholder until their posting flow lands.
    if (isVolunteer) return const VolunteerFeedScreen();

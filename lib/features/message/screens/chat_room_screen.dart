...
class _ChatRoomScreenState extends State<ChatRoomScreen> {
  ...
  String get _subtitle {
    final closed = widget.request.status == RequestStatus.closed;
...
class _Body extends StatelessWidget {
  ...
  bool get _isClosed => request.status == RequestStatus.closed;
...
String _typeName(RequestType type) {
  switch (type) {
    ...
    case RequestType.food:       return 'Food';
    case RequestType.shelter:    return 'Shelter';
    case RequestType.evacuation: return 'Evacuation';
